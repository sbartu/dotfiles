...
--    ),
    ...
    -- User programs
    awful.key({ modkey }, "F1", function () awful.spawn("thunar") end,
              {description = "run file browser", group = "launcher"}),

    awful.key({ modkey }, "F2", function () awful.spawn(browser) end,
              {description = "run browser", group = "launcher"}),

    awful.key({ modkey }, "F3", function () awful.spawn("thunderbird") end,
...
-- }}}
-- Spawn Autostart User Programs
awful.spawn.with_shell('picom -b')
awful.spawn.with_shell('nm-applet')
awful.spawn.with_shell('blueman-applet')
awful.spawn.with_shell('python ~/py_projects/start_page/app.py')
